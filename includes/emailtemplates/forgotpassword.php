...
<title>You are invited to sign a document</title>
<!--[if !mso]><!-->
							 ...
							 <table   width="100%"  class="full" border="0" cellspacing="0" cellpadding="0" object="drag-module-small" >
								<tr>
								  <td valign="top" align="left" style="font-family:'.$singleQuotes.'Lato'.$singleQuotes.', Arial, sans-serif; font-weight:400; font-size:15px; color:#ababab; line-height:25px;" class="em_center" >
									Hello [fname], someone hopefully you has requested to reset your password, if that was you click on the link below to reset and if it was not you just ignore this email.
								  </td>
								</tr>
							</table>
                                    ...
                                    <tr>
                                      <td width="100%" align="center"><!-- SORTABLE -->
                                        ...
                                        <div class="sortable_inner">
                                          ...
                                          <a href="[resetlink]" target="_blank" style="text-decoration:none; color:#ffffff; line-height:36px; display:block;" object="link-editable" > Reset Password </a>
                                          </td>
                                            </tr>
                                          </table>
                                        </div></td>
